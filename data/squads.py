...
metadict_squads['частокол'] = {
    # 50-футовый участок, пять 10x10 футовых участков.
        # Земляные элементали ломают за 1 минуту.
        # Онагры делают большой пролом за 5 минут.
        # Воздушные элементали ломают сегмент за 10 минут.
        # Бойцы с секирами на 1d12 урона справляются за 60 минут.
    'Palisade (wood)':5,
    }
...
metadict_squads['крепостная стена'] = {
    # 50-футовый участок, пять 10x10 футовых участков.
        ...
        # Онагры делают пролом за 30-60 минут.
    'Wall (stone)':5,
    }
