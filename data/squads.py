...
metadict_squads['Company-elite (абордажники Эвери) (друг)'] = {
    ...
    'Warrior 4 lvl (враг) (абордажник Эвери)':52,
    'Warrior 4 lvl (враг) (абордажник Эвери) (лидер)':15,
    'Warrior 5 lvl (враг) (лейтенант Эвери)':20,
    'Warrior 5 lvl (враг) (лейтенант Эвери) (лидер)':5,
    'Commoner 1 lvl (recruit)':300,
    }
